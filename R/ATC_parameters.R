...
#'
#' @format A `data.frame` or `data.table` with one row per ATC code. Includes the following variables:
#' \describe{
#'   \item{partial_atc}{Partial or full ATC code (character)}
#'   \item{lower_ddd_atc}{Minimum commonly used daily dose (numeric, in DDDs)}
#'   \item{usual_ddd_atc}{Usual daily dose (numeric, in DDDs)}
#'   \item{minimum_dur_atc}{Minimum allowed treatment duration (numeric, in days)}
#'   \item{maximum_dur_atc}{Maximum allowed treatment duration (numeric, in days)}
#' }
#'
#' @details
#'
...
#'
#' @seealso
#' \code{\link{pre2dup}}, \code{\link{check_atc_parameters}}
#'
#' @source Parameter set used by PRE2DUP-R.
"ATC_parameters"
